"""
Core component for Qwen framework files installation
"""
...
class CoreComponent(Component):
    """Core Qwen framework files component"""
    ...
    def get_metadata(self) -> Dict[str, str]:
        ...
        return {
            "name": "core",
            "version": __version__,
            "description": "Qwen framework documentation and core files",
            "category": "core"
        }
    
    def get_metadata_modifications(self) -> Dict[str, Any]:
        """Get metadata modifications for Qwen"""
        from .. import __version__
        return {
            "framework": {
                "version": __version__,
    ...
    def _install(self, config: Dict[str, Any]) -> bool:
        ...
        self.logger.info("Installing Qwen core framework files...")
    ...
    def _post_install(self) -> bool:
        ...
        try:
            ...
            # Migrate any existing Qwen data from settings.json
            if self.settings_manager.migrate_Qwen_data():
                self.logger.info("Migrated existing Qwen data from settings.json")
    ...
    def uninstall(self) -> bool:
        ...
        try:
            self.logger.info("Uninstalling Qwen core component...")
    ...
    def update(self, config: Dict[str, Any]) -> bool:
        ...
        try:
            self.logger.info("Updating Qwen core component...")
    ...
    def _get_source_dir(self):
        ...
        # Assume we're in Qwen/setup/components/core.py
        # and framework files are in Qwen/Qwen/Core/
        project_root = Path(__file__).parent.parent.parent
        return project_root / "Qwen" / "Core"
