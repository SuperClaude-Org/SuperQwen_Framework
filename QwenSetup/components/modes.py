"""
Modes component for Qwen behavioral modes
"""
...
class ModesComponent(Component):
    """Qwen behavioral modes component"""
    ...
    def get_metadata(self) -> Dict[str, str]:
        ...
        return {
            "name": "modes",
            "version": "4.0.9",
            "description": "Qwen behavioral modes (Brainstorming, Introspection, Task Management, Token Efficiency)",
            "category": "modes"
        }
    
    def _install(self, config: Dict[str, Any]) -> bool:
        """Install modes component"""
        self.logger.info("Installing Qwen behavioral modes...")
    ...
    def uninstall(self) -> bool:
        ...
        try:
            self.logger.info("Uninstalling Qwen modes component...")
    ...
    def _get_source_dir(self) -> Optional[Path]:
        ...
        # Assume we're in Qwen/setup/components/modes.py
        # and mode files are in Qwen/Qwen/Modes/
        project_root = Path(__file__).parent.parent.parent
        modes_dir = project_root / "Qwen" / "Modes"
